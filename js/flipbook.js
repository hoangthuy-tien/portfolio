    ...
    if(currentLocation > 1) {
        switch(currentLocation) {
            case 2:
                ...
                paper1.style.zIndex = 28;
                break;
            case 3:
                paper2.classList.remove("flipped");
                paper2.style.zIndex = 27;
                break;
            case 4:
                paper3.classList.remove("flipped");
                paper3.style.zIndex = 26;
                break;
            case 5:
                paper4.classList.remove("flipped");
                paper4.style.zIndex = 25;
                break;
            case 6:
                paper5.classList.remove("flipped");
                paper5.style.zIndex = 24;
                break;
            case 7:
                paper6.classList.remove("flipped");
                paper6.style.zIndex = 23;
                break;
            case 8:
                paper7.classList.remove("flipped");
                paper7.style.zIndex = 22;
                break;
            case 9:
                paper8.classList.remove("flipped");
                paper8.style.zIndex = 21;
                break;
            case 10:
                paper9.classList.remove("flipped");
                paper9.style.zIndex = 20;
                break;
            case 11:
                paper10.classList.remove("flipped");
                paper10.style.zIndex = 19;
                break;
            case 12:
                paper11.classList.remove("flipped");
                paper11.style.zIndex = 18;
                break;
            case 13:
                paper12.classList.remove("flipped");
                paper12.style.zIndex = 17;
                break;
            case 14:
                paper13.classList.remove("flipped");
                paper13.style.zIndex = 16;
                break;
            case 15:
                paper14.classList.remove("flipped");
                paper14.style.zIndex = 15;
                break;
            case 16:
                paper15.classList.remove("flipped");
                paper15.style.zIndex = 14;
                break;
            case 17:
                paper16.classList.remove("flipped");
                paper16.style.zIndex = 13;
                break;
            case 18:
                paper17.classList.remove("flipped");
                paper17.style.zIndex = 12;
                break;
            case 19:
                paper18.classList.remove("flipped");
                paper18.style.zIndex = 11;
                break;
            case 20:
